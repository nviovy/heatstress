library(ggplot2)
 cc <- read.table("histtLAITS_1",header=FALSE,sep = " ",dec=".")
 cc2 <- read.table("histtLAITS_2",header=FALSE,sep = " ",dec=".")
 cc3 <- read.table("histtLAITS_3",header=FALSE,sep = " ",dec=".")
 cc4 <- read.table("histtLAITS_4",header=FALSE,sep = " ",dec=".")
cc5 <- read.table("histtLAITS_5",header=FALSE,sep = " ",dec=".")
